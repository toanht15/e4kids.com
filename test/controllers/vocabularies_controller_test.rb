...
class VocabulariesControllerTest < ActionController::TestCase
  ...
  test "should create vocabulary" do
    assert_difference('Vocabulary.count') do
      post :create, vocabulary: { mean: @vocabulary.mean, subject_id: @vocabulary.subject_id, word: @vocabulary.word }
    end
  ...
  test "should update vocabulary" do
    patch :update, id: @vocabulary, vocabulary: { mean: @vocabulary.mean, subject_id: @vocabulary.subject_id, word: @vocabulary.word }
    assert_redirected_to vocabulary_path(assigns(:vocabulary))
  end
