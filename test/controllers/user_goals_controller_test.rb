...
class UserGoalsControllerTest < ActionController::TestCase
  ...
  test "should create user_goal" do
    assert_difference('UserGoal.count') do
      post :create, user_goal: { end_time: @user_goal.end_time, numbers_of_words: @user_goal.numbers_of_words, start_time: @user_goal.start_time, user_id: @user_goal.user_id }
    end
  ...
  test "should update user_goal" do
    patch :update, id: @user_goal, user_goal: { end_time: @user_goal.end_time, numbers_of_words: @user_goal.numbers_of_words, start_time: @user_goal.start_time, user_id: @user_goal.user_id }
    assert_redirected_to user_goal_path(assigns(:user_goal))
  end
